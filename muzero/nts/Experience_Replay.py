...
# save environment trajectories and sample sub trajectories
    ...
    # k = unroll steps | n = n-step-return | gamma = discount
        ...
        if len(self.memory[memory_index]["vs"]) == 500:
            traj_length = self.memory[memory_index]["length"] - n - k - 1
            traj_last_index = self.memory[memory_index]["length"] - 1
        else:
